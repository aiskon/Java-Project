...
public class ManagerProfile extends javax.swing.JFrame {
    ...
    ManagerProfile(Manager manager) {
        ...
        jTextField1.setText(manager.GetFullName());
        jTextField2.setText(manager.GetUsername());
        jTextField3.setText(manager.GetGender());
        jTextField4.setText(manager.GetFullName());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        ManagerUserRegistration frame = new ManagerUserRegistration();//КастомерЛогин класс, и назвать фрейм
